...
# CHANGED to launched: this page is live, not collecting a waitlist.
# NOTE this default is what actually wins — build.sh always passes
# -DLAUNCH_MODE, so the default in lib/config/env.dart never applies
# to a build made through this script. Both were changed together.
