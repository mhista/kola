...
const _templates = [
  ...
  _Template(
    ...
    desc: 'Submit a Meta-approved template so kymaa can send your product list to a customer who asked, as cheaply as WhatsApp allows',
            ...
            div(
              ...
              [
                ...
                div(
                  ...
                  [
                    Component.text(
                      'Errands are tools kymaa can call mid-conversation — the AI decides when to use one and figures out what values to pass.',
                    ),
                  ],
                ),
              ],
  ...
  Component _builtinForm(_Template template) {
    return div(
      ...
      [
        ...
        _field(
          labelText: 'When should kymaa use this?',
        ...
        div(
          ...
          [
            Component.text(
              'kymaa will figure out what details to pass from the conversation — no fields to fill in for this Errand type.',
            ),
          ],
        ),
      ],
  ...
  Component _chatCustomForm() {
    return div(
      ...
      [
        ...
        _field(
          labelText: 'What does this Errand do, and when should kymaa use it?',
          child: textarea(
        ...
        div([
          div(
            ...
            [Component.text('What information will kymaa need to figure out? — just describe each, not exact values')],
          ),
    ...
    return div(
      ...
      [
        ...
        div([
          div(
            attributes: {'style': 'font-size:12.5px;color:${KolaDashboardColors.mutedSecondary};margin-bottom:8px'},
            [Component.text('What information does this need? — kymaa infers the actual value at call time')],
          ),
