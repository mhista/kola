...
import 'package:kola_client/src/protocol/workspace_answer.dart' as _i25;
...
import 'package:kola_client/src/protocol/payment_gateway_credential.dart'
    as _i27;
import 'package:kola_client/src/protocol/payment_transaction.dart' as _i28;
import 'package:kola_client/src/protocol/api_key.dart' as _i29;
import 'package:kola_client/src/protocol/created_api_key.dart' as _i30;
...
class EndpointFinding extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i22.WorkspaceFinding>> listFindings(
    String accessToken,
    int workspaceId,
  ) => caller.callServerEndpoint<List<_i22.WorkspaceFinding>>(
    'finding',
    'listFindings',
    {
      'accessToken': accessToken,
...
class EndpointInvoice extends _i1.EndpointRef {
  ...
  _i2.Future<_i23.Invoice> createInvoice(
    String accessToken,
    int workspaceId,
    String billToName,
    String linesJson, {
    ...
    DateTime? dueAt,
  }) => caller.callServerEndpoint<_i23.Invoice>(
    'invoice',
    'createInvoice',
    {
      'accessToken': accessToken,
  ...
  _i2.Future<List<_i23.Invoice>> listInvoices(
    String accessToken,
    int workspaceId, {
    required int limit,
    required int offset,
  }) => caller.callServerEndpoint<List<_i23.Invoice>>(
    'invoice',
    'listInvoices',
    {
      'accessToken': accessToken,
  ...
  _i2.Future<_i23.Invoice?> getInvoice(
    String accessToken,
    int workspaceId,
    int invoiceId,
  ) => caller.callServerEndpoint<_i23.Invoice?>(
  ...
  _i2.Future<_i23.Invoice?> getInvoiceForSale(
    String accessToken,
    int workspaceId,
    int saleId,
  ) => caller.callServerEndpoint<_i23.Invoice?>(
  ...
  _i2.Future<_i23.Invoice> updateInvoiceStatus(
    String accessToken,
    int workspaceId,
    int invoiceId,
    String status,
  ...
  _i2.Future<_i23.Invoice> recordPayment(
    String accessToken,
    int workspaceId,
    int invoiceId,
    int amountMinor,
...
class EndpointKnowledge extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i24.KnowledgeSearchHit>> searchMemory(
    String accessToken,
    int workspaceId,
    String query,
  ) => caller.callServerEndpoint<List<_i24.KnowledgeSearchHit>>(
    'knowledge',
    'searchMemory',
    {
      'accessToken': accessToken,
  ...
  _i2.Future<_i25.WorkspaceAnswer> askWorkspace(
    String accessToken,
    int workspaceId,
    String question,
  ) => caller.callServerEndpoint<_i25.WorkspaceAnswer>(
    'knowledge',
    'askWorkspace',
    {
      'accessToken': accessToken,
...
class EndpointOwnerNotification extends _i1.EndpointRef {
  ...
  _i2.Future<_i26.OwnerNotificationSettings?> getSettings(
    String accessToken,
    int workspaceId,
  ) => caller.callServerEndpoint<_i26.OwnerNotificationSettings?>(
    'ownerNotification',
    'getSettings',
    {
      'accessToken': accessToken,
  ...
  _i2.Future<_i26.OwnerNotificationSettings> updateSettings(
    String accessToken,
    int workspaceId, {
    String? ownerEmail,
...
class EndpointPayment extends _i1.EndpointRef {
  ...
  /// other gateway.
  _i2.Future<_i27.PaymentGatewayCredential> connectGateway(
    String accessToken,
    int workspaceId,
    String gateway,
    String secretKey, {
    ...
    String? apiKey,
  }) => caller.callServerEndpoint<_i27.PaymentGatewayCredential>(
    'payment',
    'connectGateway',
    {
      'accessToken': accessToken,
  ...
  _i2.Future<List<_i27.PaymentGatewayCredential>> listConnectedGateways(
    String accessToken,
    int workspaceId,
  ) => caller.callServerEndpoint<List<_i27.PaymentGatewayCredential>>(
    'payment',
  ...
  _i2.Future<_i28.PaymentTransaction> initializeCheckout(
    String accessToken,
    int workspaceId,
    String gateway,
    int amountKobo,
  ...
  }) => caller.callServerEndpoint<_i28.PaymentTransaction>(
    'payment',
    'initializeCheckout',
    {
      'accessToken': accessToken,
  ...
  _i2.Future<_i28.PaymentTransaction?> getTransaction(
    String accessToken,
    int workspaceId,
    int transactionId,
  ) => caller.callServerEndpoint<_i28.PaymentTransaction?>(
  ...
  _i2.Future<_i28.PaymentTransaction> releaseHold(
    String accessToken,
    int workspaceId,
    int transactionId,
  ) => caller.callServerEndpoint<_i28.PaymentTransaction>(
...
class EndpointPlatform extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i29.ApiKey>> listApiKeys(
    String accessToken,
    int workspaceId,
  ) => caller.callServerEndpoint<List<_i29.ApiKey>>(
    'platform',
    'listApiKeys',
    {
      'accessToken': accessToken,
  ...
  _i2.Future<_i30.CreatedApiKey> createApiKey(
    String accessToken,
    int workspaceId,
    String name,
    String scope,
  ) => caller.callServerEndpoint<_i30.CreatedApiKey>(
    'platform',
    'createApiKey',
    {
      'accessToken': accessToken,
  ...
  _i2.Future<List<_i31.WebhookEndpoint>> listWebhookEndpoints(
    String accessToken,
    int workspaceId,
  ) => caller.callServerEndpoint<List<_i31.WebhookEndpoint>>(
    'platform',
  ...
  _i2.Future<_i31.WebhookEndpoint> saveWebhookEndpoint(
    String accessToken,
    int workspaceId,
    String url,
    List<String> events,
  ) => caller.callServerEndpoint<_i31.WebhookEndpoint>(
    'platform',
    'saveWebhookEndpoint',
    {
      'accessToken': accessToken,
...
class EndpointProduct extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i32.Product>> listProducts(
    String accessToken,
    int workspaceId, {
    required bool includeArchived,
  }) => caller.callServerEndpoint<List<_i32.Product>>(
    'product',
    'listProducts',
    {
      'accessToken': accessToken,
  ...
  _i2.Future<_i32.Product?> getProduct(
    String accessToken,
    int workspaceId,
    int productId,
  ) => caller.callServerEndpoint<_i32.Product?>(
    'product',
    'getProduct',
    {
      'accessToken': accessToken,
  ...
  _i2.Future<List<_i33.ProductVariant>> listVariants(
    String accessToken,
    int workspaceId,
    int productId,
  ) => caller.callServerEndpoint<List<_i33.ProductVariant>>(
    'product',
    'listVariants',
    {
      'accessToken': accessToken,
  ...
  _i2.Future<_i32.Product> createProduct(
    String accessToken,
    int workspaceId,
    String name, {
    String? description,
  ...
  _i2.Future<_i32.Product> updateProduct(
    String accessToken,
    int workspaceId,
    int productId, {
    String? name,
  ...
  _i2.Future<List<_i33.ProductVariant>> replaceVariants(
    String accessToken,
    int workspaceId,
    int productId,
    List<String> labels,
