...
/// {@category Endpoint}
class EndpointIntelligence extends _i1.EndpointRef {
  EndpointIntelligence(_i1.EndpointCaller caller) : super(caller);
...
class EndpointKnowledge extends _i1.EndpointRef {
  ...
  _i2.Future<_i4.KnowledgeDocument> setFeedingEnabled(
    String accessToken,
    int workspaceId,
    int documentId,
    bool enabled,
