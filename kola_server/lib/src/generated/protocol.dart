...
import 'subscription.dart' as _i27;
import 'support_ticket.dart' as _i28;
import 'usage_record.dart' as _i29;
import 'waitlist_signup.dart' as _i30;
import 'webhook_endpoint.dart' as _i31;
import 'whatsapp_message_template.dart' as _i32;
import 'workspace.dart' as _i33;
import 'workspace_connector.dart' as _i34;
import 'workspace_feature_override.dart' as _i35;
import 'workspace_member.dart' as _i36;
import 'package:kola_server/src/generated/bot.dart' as _i37;
import 'package:kola_server/src/generated/channel.dart' as _i38;
import 'package:kola_server/src/generated/connector_status.dart' as _i39;
import 'package:kola_server/src/generated/conversation.dart' as _i40;
import 'package:kola_server/src/generated/message.dart' as _i41;
import 'package:kola_server/src/generated/errand.dart' as _i42;
import 'package:kola_server/src/generated/knowledge_document.dart' as _i43;
import 'package:kola_server/src/generated/knowledge_search_hit.dart' as _i44;
import 'package:kola_server/src/generated/payment_gateway_credential.dart'
    as _i45;
import 'package:kola_server/src/generated/api_key.dart' as _i46;
import 'package:kola_server/src/generated/webhook_endpoint.dart' as _i47;
import 'package:kola_server/src/generated/support_ticket.dart' as _i48;
import 'package:kola_server/src/generated/whatsapp_message_template.dart'
    as _i49;
import 'package:kola_server/src/generated/workspace.dart' as _i50;
export 'api_key.dart';
export 'bot.dart';
export 'channel.dart';
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i27.Subscription) {
      return _i27.Subscription.fromJson(data) as T;
    }
    if (t == _i28.SupportTicket) {
      return _i28.SupportTicket.fromJson(data) as T;
    }
    if (t == _i29.UsageRecord) {
      return _i29.UsageRecord.fromJson(data) as T;
    }
    if (t == _i30.WaitlistSignup) {
      return _i30.WaitlistSignup.fromJson(data) as T;
    }
    if (t == _i31.WebhookEndpoint) {
      return _i31.WebhookEndpoint.fromJson(data) as T;
    }
    if (t == _i32.WhatsAppMessageTemplate) {
      return _i32.WhatsAppMessageTemplate.fromJson(data) as T;
    }
    if (t == _i33.Workspace) {
      return _i33.Workspace.fromJson(data) as T;
    }
    if (t == _i34.WorkspaceConnector) {
      return _i34.WorkspaceConnector.fromJson(data) as T;
    }
    if (t == _i35.WorkspaceFeatureOverride) {
      return _i35.WorkspaceFeatureOverride.fromJson(data) as T;
    }
    if (t == _i36.WorkspaceMember) {
      return _i36.WorkspaceMember.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i27.Subscription?>()) {
      return (data != null ? _i27.Subscription.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i28.SupportTicket?>()) {
      return (data != null ? _i28.SupportTicket.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i29.UsageRecord?>()) {
      return (data != null ? _i29.UsageRecord.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i30.WaitlistSignup?>()) {
      return (data != null ? _i30.WaitlistSignup.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i31.WebhookEndpoint?>()) {
      return (data != null ? _i31.WebhookEndpoint.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i32.WhatsAppMessageTemplate?>()) {
      return (data != null ? _i32.WhatsAppMessageTemplate.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i33.Workspace?>()) {
      return (data != null ? _i33.Workspace.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i34.WorkspaceConnector?>()) {
      return (data != null ? _i34.WorkspaceConnector.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i35.WorkspaceFeatureOverride?>()) {
      return (data != null
              ? _i35.WorkspaceFeatureOverride.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i36.WorkspaceMember?>()) {
      return (data != null ? _i36.WorkspaceMember.fromJson(data) : null) as T;
    }
    ...
    if (t == List<_i37.Bot>) {
      return (data as List).map((e) => deserialize<_i37.Bot>(e)).toList() as T;
    }
    if (t == List<_i38.Channel>) {
      return (data as List).map((e) => deserialize<_i38.Channel>(e)).toList()
          as T;
    }
    if (t == List<_i39.ConnectorStatus>) {
      return (data as List)
              .map((e) => deserialize<_i39.ConnectorStatus>(e))
              .toList()
          as T;
    }
    ...
    if (t == List<_i40.Conversation>) {
      return (data as List)
              .map((e) => deserialize<_i40.Conversation>(e))
              .toList()
          as T;
    }
    ...
    if (t == List<_i42.Errand>) {
      return (data as List).map((e) => deserialize<_i42.Errand>(e)).toList()
          as T;
    }
    if (t == List<String>) {
      return (data as List).map((e) => deserialize<String>(e)).toList() as T;
    }
    if (t == List<_i43.KnowledgeDocument>) {
      return (data as List)
              .map((e) => deserialize<_i43.KnowledgeDocument>(e))
              .toList()
          as T;
    }
    if (t == List<_i44.KnowledgeSearchHit>) {
      return (data as List)
              .map((e) => deserialize<_i44.KnowledgeSearchHit>(e))
              .toList()
          as T;
    }
    if (t == List<_i45.PaymentGatewayCredential>) {
      return (data as List)
              .map((e) => deserialize<_i45.PaymentGatewayCredential>(e))
              .toList()
          as T;
    }
    ...
    if (t == List<_i46.ApiKey>) {
      return (data as List).map((e) => deserialize<_i46.ApiKey>(e)).toList()
          as T;
    }
    if (t == List<_i47.WebhookEndpoint>) {
      return (data as List)
              .map((e) => deserialize<_i47.WebhookEndpoint>(e))
              .toList()
          as T;
    }
    if (t == List<_i48.SupportTicket>) {
      return (data as List)
              .map((e) => deserialize<_i48.SupportTicket>(e))
              .toList()
          as T;
    }
    if (t == List<_i49.WhatsAppMessageTemplate>) {
      return (data as List)
              .map((e) => deserialize<_i49.WhatsAppMessageTemplate>(e))
              .toList()
          as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i27.Subscription => 'Subscription',
      _i28.SupportTicket => 'SupportTicket',
      _i29.UsageRecord => 'UsageRecord',
      _i30.WaitlistSignup => 'WaitlistSignup',
      _i31.WebhookEndpoint => 'WebhookEndpoint',
      _i32.WhatsAppMessageTemplate => 'WhatsAppMessageTemplate',
      _i33.Workspace => 'Workspace',
      _i34.WorkspaceConnector => 'WorkspaceConnector',
      _i35.WorkspaceFeatureOverride => 'WorkspaceFeatureOverride',
      _i36.WorkspaceMember => 'WorkspaceMember',
      _ => null,
    };
  }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i27.Subscription():
        return 'Subscription';
      case _i28.SupportTicket():
        return 'SupportTicket';
      case _i29.UsageRecord():
        return 'UsageRecord';
      case _i30.WaitlistSignup():
        return 'WaitlistSignup';
      case _i31.WebhookEndpoint():
        return 'WebhookEndpoint';
      case _i32.WhatsAppMessageTemplate():
        return 'WhatsAppMessageTemplate';
      case _i33.Workspace():
        return 'Workspace';
      case _i34.WorkspaceConnector():
        return 'WorkspaceConnector';
      case _i35.WorkspaceFeatureOverride():
        return 'WorkspaceFeatureOverride';
      case _i36.WorkspaceMember():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Subscription') {
      return deserialize<_i27.Subscription>(data['data']);
    }
    if (dataClassName == 'SupportTicket') {
      return deserialize<_i28.SupportTicket>(data['data']);
    }
    if (dataClassName == 'UsageRecord') {
      return deserialize<_i29.UsageRecord>(data['data']);
    }
    if (dataClassName == 'WaitlistSignup') {
      return deserialize<_i30.WaitlistSignup>(data['data']);
    }
    if (dataClassName == 'WebhookEndpoint') {
      return deserialize<_i31.WebhookEndpoint>(data['data']);
    }
    if (dataClassName == 'WhatsAppMessageTemplate') {
      return deserialize<_i32.WhatsAppMessageTemplate>(data['data']);
    }
    if (dataClassName == 'Workspace') {
      return deserialize<_i33.Workspace>(data['data']);
    }
    if (dataClassName == 'WorkspaceConnector') {
      return deserialize<_i34.WorkspaceConnector>(data['data']);
    }
    if (dataClassName == 'WorkspaceFeatureOverride') {
      return deserialize<_i35.WorkspaceFeatureOverride>(data['data']);
    }
    if (dataClassName == 'WorkspaceMember') {
      return deserialize<_i36.WorkspaceMember>(data['data']);
    }
