...
import '../endpoints/admin/admin_auth_endpoint.dart' as _i2;
import '../endpoints/admin/admin_feature_endpoint.dart' as _i3;
import '../endpoints/bot_endpoint.dart' as _i4;
import '../endpoints/broadcast_endpoint.dart' as _i5;
import '../endpoints/channel_endpoint.dart' as _i6;
import '../endpoints/connector_endpoint.dart' as _i7;
import '../endpoints/conversation_endpoint.dart' as _i8;
import '../endpoints/customer_endpoint.dart' as _i9;
import '../endpoints/errand_endpoint.dart' as _i10;
import '../endpoints/feature_endpoint.dart' as _i11;
import '../endpoints/finding_endpoint.dart' as _i12;
import '../endpoints/invoice_endpoint.dart' as _i13;
import '../endpoints/knowledge_endpoint.dart' as _i14;
import '../endpoints/owner_notification_endpoint.dart' as _i15;
import '../endpoints/payment_endpoint.dart' as _i16;
import '../endpoints/platform_endpoint.dart' as _i17;
import '../endpoints/product_endpoint.dart' as _i18;
import '../endpoints/report_endpoint.dart' as _i19;
import '../endpoints/sale_endpoint.dart' as _i20;
import '../endpoints/support_ticket_endpoint.dart' as _i21;
import '../endpoints/waitlist_endpoint.dart' as _i22;
import '../endpoints/whatsapp_template_endpoint.dart' as _i23;
import '../endpoints/workspace_endpoint.dart' as _i24;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      ...
      'adminFeature': _i3.AdminFeatureEndpoint()
        ..initialize(
          server,
          'adminFeature',
          null,
      ...
      'channel': _i6.ChannelEndpoint()
        ..initialize(
          server,
          'channel',
          null,
        ),
      'connector': _i7.ConnectorEndpoint()
        ..initialize(
          server,
          'connector',
          null,
        ),
      'conversation': _i8.ConversationEndpoint()
        ..initialize(
          server,
          'conversation',
          null,
        ),
      'customer': _i9.CustomerEndpoint()
        ..initialize(
          server,
          'customer',
          null,
        ),
      'errand': _i10.ErrandEndpoint()
        ..initialize(
          server,
          'errand',
          null,
        ),
      'feature': _i11.FeatureEndpoint()
        ..initialize(
          server,
          'feature',
          null,
        ),
      'finding': _i12.FindingEndpoint()
        ..initialize(
          server,
          'finding',
          null,
        ),
      'invoice': _i13.InvoiceEndpoint()
        ..initialize(
          server,
          'invoice',
          null,
        ),
      'knowledge': _i14.KnowledgeEndpoint()
        ..initialize(
          server,
          'knowledge',
          null,
        ),
      'ownerNotification': _i15.OwnerNotificationEndpoint()
        ..initialize(
          server,
          'ownerNotification',
          null,
        ),
      'payment': _i16.PaymentEndpoint()
        ..initialize(
          server,
          'payment',
          null,
        ),
      'platform': _i17.PlatformEndpoint()
        ..initialize(
          server,
          'platform',
          null,
        ),
      'product': _i18.ProductEndpoint()
        ..initialize(
          server,
          'product',
          null,
        ),
      'report': _i19.ReportEndpoint()
        ..initialize(
          server,
          'report',
          null,
        ),
      'sale': _i20.SaleEndpoint()
        ..initialize(
          server,
          'sale',
          null,
        ),
      'supportTicket': _i21.SupportTicketEndpoint()
        ..initialize(
          server,
          'supportTicket',
          null,
        ),
      'waitlist': _i22.WaitlistEndpoint()
        ..initialize(
          server,
          'waitlist',
          null,
        ),
      'whatsAppTemplate': _i23.WhatsAppTemplateEndpoint()
        ..initialize(
          server,
          'whatsAppTemplate',
          null,
        ),
      'workspace': _i24.WorkspaceEndpoint()
        ..initialize(
          server,
          'workspace',
          null,
        ...
        'listFlags': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['adminFeature'] as _i3.AdminFeatureEndpoint)
                  .listFlags(
                    session,
                    params['adminToken'],
                  ),
        ...
        'createBot': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['bot'] as _i4.BotEndpoint).createBot(
                session,
                params['accessToken'],
                params['workspaceId'],
                params['name'],
        ...
        'createBotFromDescription': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['bot'] as _i4.BotEndpoint)
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['bot'] as _i4.BotEndpoint).listBotsForWorkspace(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                  ),
        ...
        'getBot': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['bot'] as _i4.BotEndpoint).getBot(
                session,
                params['accessToken'],
                params['workspaceId'],
                params['botId'],
        ...
        'updateBot': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['bot'] as _i4.BotEndpoint).updateBot(
                session,
                params['accessToken'],
                params['workspaceId'],
                params['botId'],
        ...
        'setKnowledgeSeed': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['bot'] as _i4.BotEndpoint).setKnowledgeSeed(
                session,
                params['accessToken'],
                params['workspaceId'],
                params['botId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['bot'] as _i4.BotEndpoint).setCostSavingContacts(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['botId'],
        ...
        'createBroadcast': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['broadcast'] as _i5.BroadcastEndpoint)
                  .createBroadcast(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
        ...
        'connectTelegramChannel': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['channel'] as _i6.ChannelEndpoint)
        ...
        'listConnectors': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['connector'] as _i7.ConnectorEndpoint)
                  .listConnectors(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
        ...
        'listEscalated': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['conversation'] as _i8.ConversationEndpoint)
                  .listEscalated(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['customer'] as _i9.CustomerEndpoint).listCustomers(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    limit: params['limit'],
        ...
        'getCustomerDetail': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['customer'] as _i9.CustomerEndpoint)
                  .getCustomerDetail(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
        ...
        'createBuiltinErrand': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['errand'] as _i10.ErrandEndpoint)
                  .createBuiltinErrand(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
        ...
        'getErrand': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['errand'] as _i10.ErrandEndpoint).getErrand(
                session,
                params['accessToken'],
                params['workspaceId'],
                params['errandId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['errand'] as _i10.ErrandEndpoint).setErrandStatus(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['errandId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['errand'] as _i10.ErrandEndpoint).deleteErrand(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['errandId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['errand'] as _i10.ErrandEndpoint).executeErrand(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['errandId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['errand'] as _i10.ErrandEndpoint).discoverDbSchema(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['connectionString'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['errand'] as _i10.ErrandEndpoint).getEntityMapping(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['errandId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['errand'] as _i10.ErrandEndpoint).setEntityMapping(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['errandId'],
        ...
        'listEnabledFeatures': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['feature'] as _i11.FeatureEndpoint)
                  .listEnabledFeatures(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['finding'] as _i12.FindingEndpoint).listFindings(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                  ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['finding'] as _i12.FindingEndpoint).dismissFinding(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['findingId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['invoice'] as _i13.InvoiceEndpoint).createInvoice(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['billToName'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['invoice'] as _i13.InvoiceEndpoint).listInvoices(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    limit: params['limit'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['invoice'] as _i13.InvoiceEndpoint).getInvoice(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['invoiceId'],
        ...
        'getInvoiceForSale': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['invoice'] as _i13.InvoiceEndpoint)
                  .getInvoiceForSale(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['invoice'] as _i13.InvoiceEndpoint).recordPayment(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['invoiceId'],
        ...
        'listDocuments': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['knowledge'] as _i14.KnowledgeEndpoint)
                  .listDocuments(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
              ...
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['ownerNotification']
                          as _i15.OwnerNotificationEndpoint)
                      .getSettings(
                        session,
                        params['accessToken'],
                        params['workspaceId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['payment'] as _i16.PaymentEndpoint).connectGateway(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['gateway'],
        ...
        'listConnectedGateways': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['payment'] as _i16.PaymentEndpoint)
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['payment'] as _i16.PaymentEndpoint).getTransaction(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['payment'] as _i16.PaymentEndpoint).releaseHold(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['transactionId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['platform'] as _i17.PlatformEndpoint).listApiKeys(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                  ),
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['platform'] as _i17.PlatformEndpoint).createApiKey(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['name'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['platform'] as _i17.PlatformEndpoint).revokeApiKey(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['keyId'],
        ...
        'listWebhookEndpoints': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['platform'] as _i17.PlatformEndpoint)
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['product'] as _i18.ProductEndpoint).listProducts(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['product'] as _i18.ProductEndpoint).getProduct(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['productId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['product'] as _i18.ProductEndpoint).listVariants(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['productId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['product'] as _i18.ProductEndpoint).createProduct(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['name'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['product'] as _i18.ProductEndpoint).updateProduct(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['productId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['product'] as _i18.ProductEndpoint).archiveProduct(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['productId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['product'] as _i18.ProductEndpoint).listMedia(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
                    params['productId'],
        ...
        'getEndOfDayReport': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['report'] as _i19.ReportEndpoint)
                  .getEndOfDayReport(
                    session,
                    params['accessToken'],
                    params['workspaceId'],
        ...
        'ringUpSale': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['sale'] as _i20.SaleEndpoint).ringUpSale(
                session,
                params['accessToken'],
                params['workspaceId'],
        ...
        'listSales': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['sale'] as _i20.SaleEndpoint).listSales(
                session,
                params['accessToken'],
                params['workspaceId'],
                limit: params['limit'],
        ...
        'getSaleLines': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['sale'] as _i20.SaleEndpoint).getSaleLines(
                session,
                params['accessToken'],
                params['workspaceId'],
                params['saleId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['supportTicket'] as _i21.SupportTicketEndpoint)
                      .list(
                        session,
                        params['accessToken'],
                        params['workspaceId'],
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['waitlist'] as _i22.WaitlistEndpoint).joinWaitlist(
                    session,
                    params['email'],
                    params['source'],
                    name: params['name'],
              ...
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['whatsAppTemplate']
                          as _i23.WhatsAppTemplateEndpoint)
                      .createTemplate(
                        session,
                        params['accessToken'],
                        params['workspaceId'],
        ...
        'createWorkspace': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['workspace'] as _i24.WorkspaceEndpoint)
                  .createWorkspace(
                    session,
                    params['accessToken'],
                    params['name'],
